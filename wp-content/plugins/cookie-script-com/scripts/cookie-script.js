...
if(!(!!CookieScript && !!CookieScript.instance)) {
  var CookieScript = function () {
    ...
    this.initTime = null;
    this.saveTime = '2024-07-15 21:10:23';
    this.consentTime = 1718101337;
    ...
    var _enableShopifyApi = function () {
      if(currentPlugin && currentPlugin === 'shopify') {
    ...
    var _isAuth = function () {
          var scriptAllowUrl = 'cookie-script.com/s/508b2f768fb48b5e93a7843af8d1f66d.js';
